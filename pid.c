...
uint32_t pid_float_to_param(PID *pid, float in) {
...
bool pid_configure(PID *pid, float kp, float ki, float kd, float hz, int bits, bool sign) {
  pid_clear(pid);
